...
namespace AriDEVParser.Enums
{
    public enum Opcode
    {
        ...
        CMSG_CHANNEL_OWNER                                       = 0x0,
        CMSG_CHANNEL_PASSWORD                                    = 0x0,
        CMSG_CHANNEL_ROSTER_INFO                                 = 0x0,
        CMSG_CHANNEL_SET_OWNER                                   = 0x0,
        CMSG_CHANNEL_SILENCE_ALL                                 = 0x0,
        CMSG_CHANNEL_SILENCE_VOICE                               = 0x0,
        CMSG_CHANNEL_UNBAN                                       = 0x0,
        CMSG_CHANNEL_UNMODERATOR                                 = 0x0,
        CMSG_CHANNEL_UNMUTE                                      = 0x0,
        CMSG_CHANNEL_UNSILENCE_ALL                               = 0x0,
        ...
        CMSG_GUILD_DEL_RANK                                      = 0x0,
        CMSG_GUILD_DEMOTE                                        = 0x0,
        CMSG_GUILD_DISBAND                                       = 0x0,
        CMSG_GUILD_EVENT_LOG_QUERY                               = 0x0,
        CMSG_GUILD_INFO                                          = 0x0,
        CMSG_GUILD_INFO_TEXT                                     = 0x0,
        CMSG_GUILD_INVITE                                        = 0x0,
        CMSG_GUILD_LEAVE                                         = 0x0,
        CMSG_GUILD_MEMBER_SEND_SOR_REQUEST                       = 0x0,
        CMSG_GUILD_MOTD                                          = 0x0,
        CMSG_GUILD_NEWS_UPDATE_STICKY                            = 0x0,
        ...
        CMSG_GUILD_REQUEST_PARTY_STATE                           = 0x0,
        CMSG_GUILD_ROSTER                                        = 0x0,
        CMSG_GUILD_SET_ACHIEVEMENT_TRACKING                      = 0x0,
        CMSG_GUILD_SET_GUILD_MASTER                              = 0x0,
        CMSG_GUILD_SET_NOTE                                      = 0x0,
        ...
        CMSG_LFG_LOCK_INFO_REQUEST                               = 0x0,
        CMSG_LFG_PROPOSAL_RESULT                                 = 0x0,
        CMSG_LFG_SET_BOOT_VOTE                                   = 0x0,
        CMSG_LFG_SET_COMMENT                                     = 0x0,
        CMSG_LFG_SET_ROLES                                       = 0x0,
        ...
        CMSG_MESSAGECHAT_ADDON_OFFICER                           = 0x0,
        ...
        CMSG_SET_ACTIVE_MOVER                                    = 0x1A4D, // 5.4.1 17538
        ...
        CMSG_SWAP_ITEM                                           = 0x0806, // 5.4.1 17538
        CMSG_SYNC_DANCE                                          = 0x0,
        ...
        MSG_MOVE_SET_WALK_MODE                                   = 0x0BE1, // 5.4.1 17538
        MSG_MOVE_SET_WALK_SPEED_CHEAT                            = 0x0,
        MSG_MOVE_START_ASCEND                                    = 0x16C1, // 5.4.1 17538
        MSG_MOVE_START_BACKWARD                                  = 0x12C0, // 5.4.1 17538
        MSG_MOVE_START_DESCEND                                   = 0x0641, // 5.4.1 17538
        MSG_MOVE_START_FORWARD                                   = 0x13C9, // 5.4.1 17538
        MSG_MOVE_START_PITCH_DOWN                                = 0x16E8, // 5.4.1 17538
        MSG_MOVE_START_PITCH_UP                                  = 0x0FE1, // 5.4.1 17538
        MSG_MOVE_START_STRAFE_LEFT                               = 0x0EC8, // 5.4.1 17538
        MSG_MOVE_START_STRAFE_RIGHT                              = 0x0269, // 5.4.1 17538
        MSG_MOVE_START_SWIM                                      = 0x0FC8, // 5.4.1 17538
        MSG_MOVE_START_TURN_LEFT                                 = 0x0760, // 5.4.1 17538
        MSG_MOVE_START_TURN_RIGHT                                = 0x17C9, // 5.4.1 17538
        MSG_MOVE_STOP                                            = 0x0649, // 5.4.1 17538
        MSG_MOVE_STOP_ASCEND                                     = 0x1268, // 5.4.1 17538
        MSG_MOVE_STOP_PITCH                                      = 0x1A48, // 5.4.1 17538
        MSG_MOVE_STOP_STRAFE                                     = 0x12C9, // 5.4.1 17538
        MSG_MOVE_STOP_SWIM                                       = 0x0FC9, // 5.4.1 17538
        MSG_MOVE_STOP_TURN                                       = 0x1749, // 5.4.1 17538
        MSG_MOVE_TELEPORT                                        = 0x0A2E, // 5.4.1 17538
        ...
        SMSG_AUCTION_LIST_PENDING_SALES                          = 0x0,
        SMSG_AUCTION_LIST_RESULT                                 = 0x0,
        ...
        SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE              = 0x0,
        SMSG_BATTLEFIELD_MGR_STATE_CHANGE                        = 0x0,
        SMSG_BATTLEFIELD_PLAYER_POSITIONS                        = 0x0,
        SMSG_BATTLEFIELD_PORT_DENIED                             = 0x0,
        SMSG_BATTLEFIELD_RATED_INFO                              = 0x0,
        SMSG_BATTLEFIELD_STATUS                                  = 0x0,
        SMSG_BATTLEFIELD_STATUS_QUEUED                           = 0x0,
        ...
        SMSG_DISMOUNT                                            = 0x0,
        SMSG_DISMOUNTRESULT                                      = 0x143F, // 5.4.1 17538
        ...
        SMSG_GUILD_DECLINE                                       = 0x0,
        SMSG_GUILD_EVENT                                         = 0x0,
        SMSG_GUILD_EVENT_LOG_QUERY_RESULT                        = 0x0,
        ...
        SMSG_GUILD_REWARDS_LIST                                  = 0x0,
        SMSG_GUILD_ROSTER                                        = 0x0,
        ...
        SMSG_INITIAL_SPELLS                                      = 0x1164, // 5.4.1 17538
        ...
        SMSG_LFG_PROPOSAL_UPDATE                                 = 0x0,
        SMSG_LFG_QUEUE_STATUS                                    = 0x0,
        SMSG_LFG_ROLE_CHECK_UPDATE                               = 0x0,
        SMSG_LFG_ROLE_CHOSEN                                     = 0x0,
        SMSG_LFG_SLOT_INVALID                                    = 0x0,
        SMSG_LFG_TELEPORT_DENIED                                 = 0x0,
        SMSG_LFG_UPDATE_LIST                                     = 0x0,
        SMSG_LFG_UPDATE_SEARCH                                   = 0x0,
        SMSG_LFG_UPDATE_STATUS                                   = 0x0,
        SMSG_LFG_UPDATE_STATUS_NONE                              = 0x0,
        ...
        SMSG_MESSAGE_BOX                                         = 0x142D, // 5.4.1 17538
        ...
        SMSG_REALM_NAME_QUERY_RESPONSE                           = 0x052D, // 5.4.1 17538
        SMSG_REAL_GROUP_UPDATE                                   = 0x0,
        SMSG_RECEIVED_MAIL                                       = 0x0,
        SMSG_REDIRECT_CLIENT                                     = 0x0455, // 5.4.1 17538
        ...
        SMSG_SPLINE_MOVE_COLLISION_ENABLE                        = 0x0,
        SMSG_SPLINE_MOVE_GRAVITY_DISABLE                         = 0x0,
        SMSG_SPLINE_MOVE_GRAVITY_ENABLE                          = 0x0,
        SMSG_SPLINE_MOVE_ROOT                                    = 0x0,
        SMSG_SPLINE_MOVE_SET_ANIM                                = 0x0,
        SMSG_SPLINE_MOVE_SET_FEATHER_FALL                        = 0x0,
        SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED                   = 0x0,
        SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED                        = 0x0,
        SMSG_SPLINE_MOVE_SET_FLYING                              = 0x0,
        SMSG_SPLINE_MOVE_SET_HOVER                               = 0x0,
        SMSG_SPLINE_MOVE_SET_LAND_WALK                           = 0x0,
        SMSG_SPLINE_MOVE_SET_NORMAL_FALL                         = 0x0,
        SMSG_SPLINE_MOVE_SET_PITCH_RATE                          = 0x0,
        SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED                      = 0x0,
        SMSG_SPLINE_MOVE_SET_RUN_MODE                            = 0x0,
        SMSG_SPLINE_MOVE_SET_RUN_SPEED                           = 0x0,
        SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED                     = 0x0,
        SMSG_SPLINE_MOVE_SET_SWIM_SPEED                          = 0x0,
        SMSG_SPLINE_MOVE_SET_TURN_RATE                           = 0x0,
        SMSG_SPLINE_MOVE_SET_WALK_MODE                           = 0x0,
        SMSG_SPLINE_MOVE_SET_WALK_SPEED                          = 0x0,
        SMSG_SPLINE_MOVE_SET_WATER_WALK                          = 0x0,
        SMSG_SPLINE_MOVE_START_SWIM                              = 0x0,
        SMSG_SPLINE_MOVE_STOP_SWIM                               = 0x0,
        SMSG_SPLINE_MOVE_UNROOT                                  = 0x0,
        SMSG_SPLINE_MOVE_UNSET_FLYING                            = 0x0,
        SMSG_SPLINE_MOVE_UNSET_HOVER                             = 0x0,
        ...
        SMSG_TALENTS_INFO                                        = 0x0494, // 5.4.1 17538
        ...
        SMSG_WAIT_QUEUE_FINISH                                   = 0x0DBD, // 5.4.1 17538
        SMSG_WAIT_QUEUE_UPDATE                                   = 0x109D, // 5.4.1 17538
