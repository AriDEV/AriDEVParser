...
namespace AriDEVParser.Enums
{
    public enum Opcode
    {
        ...
        CMSG_PET_ACTION                                          = 0x0,
        CMSG_PET_BATTLE_QUEUE_JOIN                               = 0x0,
        ...
        MSG_MOVE_SET_WALK_MODE                                   = 0x0,
        MSG_MOVE_SET_WALK_SPEED_CHEAT                            = 0x0,
        MSG_MOVE_START_ASCEND                                    = 0x0,
        MSG_MOVE_START_BACKWARD                                  = 0x0,
        MSG_MOVE_START_DESCEND                                   = 0x0,
        MSG_MOVE_START_FORWARD                                   = 0x0,
        MSG_MOVE_START_PITCH_DOWN                                = 0x0,
        MSG_MOVE_START_PITCH_UP                                  = 0x0,
        MSG_MOVE_START_STRAFE_LEFT                               = 0x0,
        MSG_MOVE_START_STRAFE_RIGHT                              = 0x0,
        MSG_MOVE_START_SWIM                                      = 0x0,
        MSG_MOVE_START_TURN_LEFT                                 = 0x0,
        MSG_MOVE_START_TURN_RIGHT                                = 0x0,
        MSG_MOVE_STOP                                            = 0x0,
        MSG_MOVE_STOP_ASCEND                                     = 0x0,
        MSG_MOVE_STOP_PITCH                                      = 0x0,
        MSG_MOVE_STOP_STRAFE                                     = 0x0,
        MSG_MOVE_STOP_SWIM                                       = 0x0,
        MSG_MOVE_STOP_TURN                                       = 0x0,
